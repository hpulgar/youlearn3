...
import MODELS.RespuestasFacade;
...
@Named("respuestasController")
@SessionScoped
public class RespuestasController implements Serializable {

    private Respuestas current;
    private DataModel items = null;
    @EJB
    private MODELS.RespuestasFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Respuestas) getItems().getRowData();
    ...
    public Respuestas getRespuestas(java.lang.Integer id) {
    ...
    public static class RespuestasControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getRespuestas(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Respuestas) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Respuestas.class.getName());
            }
        }
